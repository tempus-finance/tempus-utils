...
export class ERC20OwnerMintable extends ERC20 {
   ...
   */
  async mint(sender:Signer, receiver:Addressable, amount:Numberish): Promise<void> {
   ...
   * @param amount Number of tokens to burn
   */
  async burnFrom(sender:Signer, account:Addressable, amount:Numberish): Promise<void> {
